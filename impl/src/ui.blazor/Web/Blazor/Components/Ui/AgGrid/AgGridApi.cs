...
namespace Works.Web.Blazor.Components.Ui.AgGrid
{
    ...
    /// </summary>
    public class AgGridApi
    {
        internal string CallGridApi = "works_ag_grid.gridOptions_callGridApi";

        private IJSRuntime _js;
        private string _id;

        internal AgGridApi(IJSRuntime js, string id)
        {
            _js = js;
            _id = id;
        }
        ...
        {
            return _js.InvokeVoidAsync("works_ag_grid.gridOptions_setDatasource", _id, ds).AsTask();
        }
        ...
        public class RefreshCellsParams
        {
            ...
            public AgGridRowNode[] RowNodes { get; set; }
