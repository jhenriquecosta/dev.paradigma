...
namespace Works.Web.Blazor.Components.Ui.AgGrid
{
    ...
    internal class InteropGridOptions
    {
        ...
        public AgGridOptions Options { get; set; }

        public AgGridCallbacks Callbacks { get; set; }

        public AgGridEvents Events { get; set; }
    }
    ...
    internal class InteropGridOptionsConverter : JsonConverter<InteropGridOptions>
    {
        public override InteropGridOptions Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                Options = JsonSerializer.Deserialize<AgGridOptions>(ref reader, options),
            };
        }
