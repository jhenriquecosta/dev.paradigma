...
namespace Works.Application.Reports
{
    public class WorksReportStorageWebExtension : ReportStorageWebExtension
    {
        readonly string ReportDirectory;
        const string FileExtension = ".repx";
        public WorksReportStorageWebExtension(IWebHostEnvironment env)
        {
        ...
        public override bool CanSetData(string url)
        {
            ...
            // This method is called only for valid URLs (for example, if the IsValidUrl method returned true) before the SetData method is called.
